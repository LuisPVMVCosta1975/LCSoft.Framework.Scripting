namespace LCSoft.Framework.Scripting.ScriptContent.ScriptExpression.ScriptConnectorExpression
{
    ...
    public class GreaterScriptConnectorExpression : ScriptConnectorExpressionBase
    {
        public const String ComponentName = "Greater";
        ...
        public GreaterScriptConnectorExpression(IScriptExpression ScriptExpressionLeft, IScriptExpression ScriptExpressionRight)
        {
        ...
        public override ValueContainerBase EvaluateElement(Context Context, ScriptResources ScriptResources)
        {
            ...
            return (ValueContainerLeft.IsGreaterThan(ValueContainerRight) ? ValueContainerBase.True : ValueContainerBase.False);
        }
