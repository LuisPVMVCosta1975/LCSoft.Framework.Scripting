namespace LCSoft.Framework.Scripting.ScriptContent.ScriptExpression.ScriptConnectorExpression
{
    ...
    public class NotEqualScriptConnectorExpression : ScriptConnectorExpressionBase
    {
        public const String ComponentName = "NotEqual";
        ...
        public NotEqualScriptConnectorExpression(IScriptExpression ScriptExpressionLeft, IScriptExpression ScriptExpressionRight)
        {
        ...
        public override ValueContainerBase EvaluateElement(Context Context, ScriptResources ScriptResources)
        {
            ...
            return (ValueContainerLeft.IsDifferentFrom(ValueContainerRight) ? ValueContainerBase.True : ValueContainerBase.False);
        }
