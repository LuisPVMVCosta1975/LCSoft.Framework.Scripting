namespace LCSoft.Framework.Scripting.ScriptContent.ScriptExpression.ScriptConnectorExpression
{
    ...
    public class OneScriptConnectorExpression : ScriptConnectorExpressionBase
    {
        public const String ComponentName = "One";
        ...
        public OneScriptConnectorExpression(IScriptExpression ScriptExpressionLeft, IScriptExpression ScriptExpressionRight)
        {
        ...
        public override ValueContainerBase EvaluateElement(Context Context, ScriptResources ScriptResources)
        {
            ...
            return (ValueContainerLeft.GetBoolean() ^ ValueContainerRight.GetBoolean() ? ValueContainerBase.True : ValueContainerBase.False);
        }
