namespace LCSoft.Framework.Scripting.ScriptContent.ScriptRootContent.ScriptCommand
{
    ...
    public class SelfAddScriptCommand : ScriptCommandBase
    {
        public const String ComponentName = "SelfAdd";
        ...
        public SelfAddScriptCommand(IScriptExpression ScriptExpression, String Name, IScriptExpression Key, IScriptExpression Value)
        {
        ...
        private ExecutionResult RunElementVariable(Context Context, ScriptResources ScriptResources)
        {
            ...
            if (Value != null)
            {
                ...
                VariableContext.Variables[Name] = Value1.Add(Value2);
            }
            else
            {
                VariableContext.Variables[Name] = Value1.Increment();
            }
        ...
        private ExecutionResult RunElementProperty(Context Context, ScriptResources ScriptResources)
        {
            ...
            if (Value != null)
            {
                ...
                ValueContainer.SetProperty(Name, Value1.Add(Value2));
            }
            else
            {
                ValueContainer.SetProperty(Name, Value1.Increment());
            }
        ...
        private ExecutionResult RunElementItem(Context Context, ScriptResources ScriptResources)
        {
            ...
            if (Value != null)
            {
                ...
                ValueContainer.SetItem(KeyValue, Value1.Add(Value2));
            }
            else
            {
                ValueContainer.SetItem(KeyValue, Value1.Increment());
            }
