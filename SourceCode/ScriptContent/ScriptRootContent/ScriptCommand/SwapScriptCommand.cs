namespace LCSoft.Framework.Scripting.ScriptContent.ScriptRootContent.ScriptCommand
{
    ...
    public class SwapScriptCommand : ScriptCommandBase
    {
        public const String ComponentName = "Swap";
        public const String ComponentSignature = ComponentName + " [" + ComponentType + "]";

        internal static SwapScriptCommand Parse(BookmarkableFileReader BFR)
        {
            ...
            return new SwapScriptCommand(VariableName1, VariableName2);
        }

        internal String VariableName1;
        internal String VariableName2;

        public SwapScriptCommand(String VariableName1, String VariableName2)
        {
