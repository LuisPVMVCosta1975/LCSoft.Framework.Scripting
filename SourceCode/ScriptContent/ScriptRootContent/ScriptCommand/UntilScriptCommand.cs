namespace LCSoft.Framework.Scripting.ScriptContent.ScriptRootContent.ScriptCommand
{
    ...
    public class UntilScriptCommand : ScriptCommandBase
    {
        public const String ComponentName = "Until";
        public const String ComponentSignature = ComponentName + " [" + ComponentType + "]";

        internal static UntilScriptCommand Parse(BookmarkableFileReader BFR)
        {
            ...
            return new UntilScriptCommand(Predicate, CodeBlock);
        }

        internal IScriptExpression Predicate;
        internal List<ScriptCommandBase> CodeBlock;

        public UntilScriptCommand(IScriptExpression Predicate, List<ScriptCommandBase> CodeBlock)
        {
