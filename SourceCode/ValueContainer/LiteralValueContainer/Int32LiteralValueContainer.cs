namespace LCSoft.Framework.Scripting.ValueContainer.LiteralValueContainer
{
    ...
    public class Int32LiteralValueContainer : LiteralValueContainerBase
    {
        public const String ComponentName = "Int32";
        public const String ComponentSignature = ComponentName + " [" + ComponentType + "]";

        private readonly Type ValueType;
        private readonly Int32 Value;

        public Int32LiteralValueContainer(Int32 Value)
        {
            this.Value = Value;
            this.ValueType = typeof(Int32);
        }

        public override ValueContainerBase GetFrameworkType() => ValueContainerBase.Int32DataType;
        ...
        {
            return Value == Other.GetInt32OrNull();
        }
        ...
        {
            return new Int32LiteralValueContainer(this.Value + Value.GetInt32());
        }
        ...
        {
            return new Int32LiteralValueContainer((this.Value | Value.GetInt32()) ^ Int32.MaxValue);
        }
        ...
        {
            return new Int32LiteralValueContainer(Value + 1);
        }
